<x-dosen.dosen-app>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('List Reservasi Dosen: ') . Auth::guard('dosen')->user()->name }}
        </h2>
    </x-slot>
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <section class="bg-white dark:bg-gray-900">
                        <div class="container px-6 py-10 mx-auto">
                            ...
                            <div class="grid grid-cols-1 gap-x-8 gap-y-6 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-2">
                                @foreach ($list_reservasi as $reservasi)
                                    <div
                                        onclick="location.href='{{ route('reservasi.detail.dosen', $reservasi->id) }}'"
