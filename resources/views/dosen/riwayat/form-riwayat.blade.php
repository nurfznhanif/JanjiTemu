<x-dosen.dosen-app>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ __('Form Riwayat untuk ') .  $reservasi->nama_awal . ' ' . $reservasi->nama_tengah . ' ' . $reservasi->nama_akhir }}
        </h2>
    </x-slot>
                    ...
                    <div class="mt-10 sm:mt-0">
                        <div class="md:grid md:grid-cols-3 md:gap-6">
                            ...
                            <div class="mt-5 md:mt-0 md:col-span-2">
                                <form
                                onsubmit="return confirm('Simpan dan berikan riwayat kepada mahasiswa?');"
                                action="{{ route('riwayat.dosen.create.save', $reservasi->id) }}"
                                method="POST">
                                    @csrf
                                        ...
                                        <div class="px-4 py-5 bg-white sm:p-6">
                                            <div class="grid grid-cols-6 gap-6">
                                                <div class="col-span-6">
                                                    <p class="mt-1 text-lg text-gray-600">Nama Mahasiswa:
